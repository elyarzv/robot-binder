...
#ifndef ASM_STATE_CRITICAL_BATTERY_H_
#define ASM_STATE_CRITICAL_BATTERY_H_
...
class StateCriticalBattery final: public AbstractState, public AbstractROSState
{
public: 
    StateCriticalBattery(shared_ptr<AbstractStateMachineManager> state_manager, ros::NodeHandle& nh);
    ~StateCriticalBattery() override;
...
#endif // END ASM_STATE_CRITICAL_BATTERY_H_